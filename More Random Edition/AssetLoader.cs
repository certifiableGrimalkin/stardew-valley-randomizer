...
namespace Randomizer
{
	public class AssetLoader : IAssetLoader
	{
		...
		public void RandomizeImages()
		{
            ...
            BigCritterBuilder bigCritterBuilder = new BigCritterBuilder();
            SmallCritterBuilder smallCritterBuilder = new SmallCritterBuilder();
            CrabBuilder crabBuilder = new CrabBuilder();
            LavaMonkeyBuilder lavaMonkeyBuilder = new LavaMonkeyBuilder();
            ScremBuilder scremBuilder = new ScremBuilder();
			LavaMonkeyHeadBuilder lavaMonkeyHeadBuilder = new LavaMonkeyHeadBuilder();
			IslandBrownBirdBuilder islandBrownBirdBuilder = new IslandBrownBirdBuilder();
            bigCritterBuilder.BuildImage();
			smallCritterBuilder.BuildImage();
			crabBuilder.BuildImage();
			lavaMonkeyBuilder.BuildImage();
			scremBuilder.BuildImage();
			lavaMonkeyHeadBuilder.BuildImage();
			islandBrownBirdBuilder.BuildImage();
            File.Delete(Globals.GetFilePath("Assets/CustomImages/Critter/Big-temp.png"));
            File.Delete(Globals.GetFilePath("Assets/CustomImages/Critter/BigSmall-temp.png"));
            File.Delete(Globals.GetFilePath("Assets/CustomImages/Critter/BigSmallCrab-temp.png"));
            File.Delete(Globals.GetFilePath("Assets/CustomImages/Critter/BigSmallCrabMonkey-temp.png"));
            File.Delete(Globals.GetFilePath("Assets/CustomImages/Critter/BigSmallCrabMonkeyScream-temp.png"));
            File.Delete(Globals.GetFilePath("Assets/CustomImages/Critter/BigSmallCrabMonkeyScreamHead-temp.png"));
            HandleImageReplacement(islandBrownBirdBuilder, "TileSheets/critters");
        }

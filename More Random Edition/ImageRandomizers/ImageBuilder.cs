...
namespace Randomizer
{
	public abstract class ImageBuilder
	{
        ...
        /// <summary>
        /// The image width in px - this is the initial width to start drawing at
        /// </summary>
        protected int InitialWidthOffsetInPx = 0;


        /// <summary>
        /// The image height in px - this is the initial height to start drawing at
        /// </summary>
        protected int InitialHeightOffsetInPx = 0;
        ...
        /// </summary>
        protected string OutputFileName { get; set; } = "randomizedImage.png";
		...
		public void BuildImage()
		{
			...
			foreach (Point position in PositionsToOverlay)
			{
				...
				int xOffset = position.X * OffsetWidthInPx + InitialWidthOffsetInPx;
				int yOffset = position.Y * OffsetHeightInPx + InitialHeightOffsetInPx;
		...
		public static void CleanUpReplacementFiles()
		{
            ...
            File.Delete(Globals.GetFilePath("Assets/CustomImages/Critter/randomizedImage.png"));
        }
	}
}

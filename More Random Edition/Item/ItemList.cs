	...
	public class ItemList
	{
			...
			bool onlyResources = false)
		{
			List<Item> items = Items.Values
				.Where(x =>
                    ...
                    ((itemBeingCrafted.Id != (int)ObjectIndexes.Tapper) || !x.RequiresTapper || !Globals.Config.CraftingRecipies.TappersCantUseTapperProduce) &&
		...
		public static void Initialize()
		{
			...
			{ 
                ...
                { (int)ObjectIndexes.TeaSapling, new CraftableItem((int)ObjectIndexes.TeaSapling, "/Field/251/false/null", CraftableCategories.ModerateAndNeedMany) { OverrideName = "Tea Sapling" } },
				...
				// 1.5 Craftable items
				{ (int)ObjectIndexes.FairyDust, new CraftableItem((int)ObjectIndexes.FairyDust, "/Home/872/false/null", CraftableCategories.Postgame) { OverrideName = "Fairy Dust" } },
                { (int)ObjectIndexes.BugSteak, new CraftableItem((int)ObjectIndexes.BugSteak, "/Home/874/false/", CraftableCategories.Easy,"Combat", 1) { OverrideName = "Bug Steak" } },
                { (int)ObjectIndexes.DarkSign, new CraftableItem((int)ObjectIndexes.DarkSign, "/Home/39/true/f Krobus 3", CraftableCategories.Easy) { OverrideName = "Dark Sign" } },
                { (int)ObjectIndexes.QualityBobber, new CraftableItem((int)ObjectIndexes.QualityBobber, "/Home/877/false/null", CraftableCategories.Moderate) { OverrideName = "Quality Bobber" } },
                { (int)ObjectIndexes.StoneChest, new CraftableItem((int)ObjectIndexes.StoneChest, "/Home/232/true/null", CraftableCategories.Easy) { OverrideName = "Stone Chest" } },
                { (int)ObjectIndexes.MonsterMusk, new CraftableItem((int)ObjectIndexes.MonsterMusk, "/Home/879/false/null", CraftableCategories.Difficult) { OverrideName = "Monster Musk" } },
                { (int)ObjectIndexes.MiniObelisk, new CraftableItem((int)ObjectIndexes.MiniObelisk, "/Home/238/true/null", CraftableCategories.Difficult) { OverrideName = "Mini-Obelisk" } },
                { (int)ObjectIndexes.FarmComputer, new CraftableItem((int)ObjectIndexes.FarmComputer, "/Home/239/true/null", CraftableCategories.Difficult) { OverrideName = "Farm Computer" } },
                { (int)ObjectIndexes.OstrichIncubator, new CraftableItem((int)ObjectIndexes.OstrichIncubator, "/Home/254/true/null", CraftableCategories.Postgame) { OverrideName = "Ostrich Incubator" } },
                { (int)ObjectIndexes.GeodeCrusher, new CraftableItem((int)ObjectIndexes.GeodeCrusher, "/Home/182/true/null", CraftableCategories.Moderate) { OverrideName = "Geode Crusher" } },
                { (int)ObjectIndexes.SolarPanel, new CraftableItem((int)ObjectIndexes.SolarPanel, "/Home/231/true/null", CraftableCategories.Moderate) { OverrideName = "Solar Panel" } },
                { (int)ObjectIndexes.BoneMill, new CraftableItem((int)ObjectIndexes.BoneMill, "/Home/90/true/null", CraftableCategories.Moderate) { OverrideName = "Bone Mill" } },
                { (int)ObjectIndexes.ThornsRing, new CraftableItem((int)ObjectIndexes.ThornsRing, "/Home/839/Ring/", CraftableCategories.Moderate, "Combat", 7) { OverrideName = "Thorns Ring", IsRing = true } },
                { (int)ObjectIndexes.GlowstoneRing, new CraftableItem((int)ObjectIndexes.GlowstoneRing, "/Home/888/Ring/", CraftableCategories.Moderate, "Mining", 4) { OverrideName = "Glowstone Ring", IsRing = true } },
                { (int)ObjectIndexes.HeavyTapper, new CraftableItem((int)ObjectIndexes.HeavyTapper, "/Home/264/true/null", CraftableCategories.Qi) { OverrideName = "Heavy Tapper" } },
                { (int)ObjectIndexes.Hopper, new CraftableItem((int)ObjectIndexes.Hopper, "/Home/275/true/null", CraftableCategories.Qi) },
                { (int)ObjectIndexes.MagicBait, new CraftableItem((int)ObjectIndexes.MagicBait, "/Home/908 5/false/null", CraftableCategories.Qi) { OverrideName = "Magic Bait" } },

                { (int)ObjectIndexes.RusticPlankFloor, new CraftableItem((int)ObjectIndexes.RusticPlankFloor, "/Field/840/false/l 0", CraftableCategories.EasyAndNeedMany) { OverrideName = "Rustic Plank Floor" } },
                { (int)ObjectIndexes.StoneWalkwayFloor, new CraftableItem((int)ObjectIndexes.StoneWalkwayFloor, "/Field/841/false/l 0", CraftableCategories.EasyAndNeedMany) { OverrideName = "Stone Walkway Floor" } },
                { (int)ObjectIndexes.FiberSeeds, new CraftableItem((int)ObjectIndexes.FiberSeeds, "/Home/885 4/false/null", CraftableCategories.ModerateAndNeedMany) { OverrideName = "Fiber Seeds" } },
                { (int)ObjectIndexes.WarpTotemIsland, new CraftableItem((int)ObjectIndexes.WarpTotemIsland, "/Field/886/false/null", CraftableCategories.ModerateAndNeedMany) { OverrideName = "Warp Totem: Island" } },
                { (int)ObjectIndexes.HyperSpeedGro, new CraftableItem((int)ObjectIndexes.HyperSpeedGro, "/Field/918/false/null", CraftableCategories.Qi) { OverrideName = "Hyper Speed-Gro" } },
                { (int)ObjectIndexes.DeluxeFertiliser, new CraftableItem((int)ObjectIndexes.DeluxeFertiliser, "/Field/919 5/false/null", CraftableCategories.Qi) { OverrideName = "Deluxe Fertilizer" } },
                { (int)ObjectIndexes.DeluxeRetainingSoil, new CraftableItem((int)ObjectIndexes.DeluxeRetainingSoil, "/Field/920/false/null", CraftableCategories.Qi) { OverrideName = "Deluxe Retaining Soil" } },
                { (int)ObjectIndexes.CookoutKit, new CraftableItem((int)ObjectIndexes.CookoutKit, "/Field/926/false/", CraftableCategories.Easy, "Foraging", 9) { OverrideName = "Cookout Kit" } },
				...
				{ (int)ObjectIndexes.Wood, new ResourceItem((int)ObjectIndexes.Wood) { ItemsRequiredForLargeRecipe = new Range(10,30) } },
				{ (int)ObjectIndexes.Hardwood, new ResourceItem((int)ObjectIndexes.Hardwood, 1, new Range(1, 15)) { DifficultyToObtain = ObtainingDifficulties.MediumTimeRequirements, ItemsRequiredForLargeRecipe = new Range(5,15) } },
				{ (int)ObjectIndexes.Stone, new ResourceItem((int)ObjectIndexes.Stone) { ItemsRequiredForLargeRecipe = new Range(10,30) } },
				{ (int)ObjectIndexes.Fiber, new ResourceItem((int)ObjectIndexes.Fiber, 3, new Range(1, 5)) { ItemsRequiredForLargeRecipe = new Range(10,70) } },
				{ (int)ObjectIndexes.Clay, new ResourceItem((int)ObjectIndexes.Clay, 1, new Range(1, 5)) { DifficultyToObtain = ObtainingDifficulties.SmallTimeRequirements, ItemsRequiredForLargeRecipe = new Range(5,15) } },

				// Items you get as a byproduct of collection resources
				{ (int)ObjectIndexes.Sap, new Item((int)ObjectIndexes.Sap, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 15), ItemsRequiredForLargeRecipe = new Range(100,300) } },
				{ (int)ObjectIndexes.Acorn, new Item((int)ObjectIndexes.Acorn, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(10,15) } },
				{ (int)ObjectIndexes.MapleSeed, new Item((int)ObjectIndexes.MapleSeed, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(10,15) } },
				{ (int)ObjectIndexes.PineCone, new Item((int)ObjectIndexes.PineCone, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(10,15) } },
				{ (int)ObjectIndexes.MixedSeeds, new Item((int)ObjectIndexes.MixedSeeds, ObtainingDifficulties.NoRequirements) },

				// Tapper items
				{ (int)ObjectIndexes.OakResin, new Item((int)ObjectIndexes.OakResin, ObtainingDifficulties.MediumTimeRequirements) { RequiresTapper = true, ItemsRequiredForLargeRecipe = new Range(3,5) } },
				{ (int)ObjectIndexes.MapleSyrup, new Item((int)ObjectIndexes.MapleSyrup, ObtainingDifficulties.MediumTimeRequirements) { RequiresTapper = true, ItemsRequiredForLargeRecipe = new Range(3,8) } },
				{ (int)ObjectIndexes.PineTar, new Item((int)ObjectIndexes.PineTar, ObtainingDifficulties.MediumTimeRequirements) { RequiresTapper = true, ItemsRequiredForLargeRecipe = new Range(5,10) } },

				// Items you can buy from the shops easily
				{ (int)ObjectIndexes.Hay, new Item((int)ObjectIndexes.Hay, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(10,20) } },
				{ (int)ObjectIndexes.Sugar, new Item((int)ObjectIndexes.Sugar, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(10,20)  } },
				{ (int)ObjectIndexes.Oil, new Item((int)ObjectIndexes.Oil, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(10,20)  } },
				{ (int)ObjectIndexes.WheatFlour, new Item((int)ObjectIndexes.WheatFlour, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(10,20)  } },

				// Misc fishing items
				{ (int)ObjectIndexes.Seaweed, new Item((int)ObjectIndexes.Seaweed, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(10,20)  } },
				{ (int)ObjectIndexes.GreenAlgae, new Item((int)ObjectIndexes.GreenAlgae, ObtainingDifficulties.NoRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(10,20)  } },
				{ (int)ObjectIndexes.WhiteAlgae, new Item((int)ObjectIndexes.WhiteAlgae, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(10,20)  } },
				...
				{ (int)ObjectIndexes.BugMeat, new MonsterItem((int)ObjectIndexes.BugMeat, ObtainingDifficulties.SmallTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(5,10) } },
				{ (int)ObjectIndexes.Slime, new MonsterItem((int)ObjectIndexes.Slime, ObtainingDifficulties.SmallTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 10), ItemsRequiredForLargeRecipe = new Range(10,20) } },
				{ (int)ObjectIndexes.BatWing, new MonsterItem((int)ObjectIndexes.BatWing, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(2,8) } },
				...
				{ (int)ObjectIndexes.Coal, new Item((int)ObjectIndexes.Coal, ObtainingDifficulties.SmallTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(5,10) } },
				{ (int)ObjectIndexes.CopperOre, new Item((int)ObjectIndexes.CopperOre, ObtainingDifficulties.SmallTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(5,20) } },
				{ (int)ObjectIndexes.IronOre, new Item((int)ObjectIndexes.IronOre, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(5,20) } },
				{ (int)ObjectIndexes.GoldOre, new Item((int)ObjectIndexes.GoldOre, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(5,20) } },
                { (int)ObjectIndexes.IridiumOre, new Item((int)ObjectIndexes.IridiumOre, ObtainingDifficulties.EndgameItem) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(5,20) } },
                { (int)ObjectIndexes.RadioactiveOre, new Item((int)ObjectIndexes.RadioactiveOre, ObtainingDifficulties.QiItems) { ItemsRequiredForRecipe = new Range(1, 5), ItemsRequiredForLargeRecipe = new Range(5,20) } },

                { (int)ObjectIndexes.Quartz, new Item((int)ObjectIndexes.Quartz, ObtainingDifficulties.SmallTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(2,8) } },
				{ (int)ObjectIndexes.FireQuartz, new Item((int)ObjectIndexes.FireQuartz, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(2,8) } },
				{ (int)ObjectIndexes.EarthCrystal, new Item((int)ObjectIndexes.EarthCrystal, ObtainingDifficulties.SmallTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(2,8) } },
				{ (int)ObjectIndexes.FrozenTear, new Item((int)ObjectIndexes.FrozenTear, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 3), ItemsRequiredForLargeRecipe = new Range(2,8) } },
				...
				{ (int)ObjectIndexes.OmniGeode, new Item((int)ObjectIndexes.OmniGeode, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForLargeRecipe = new Range(5, 10) } },
				...
				// 1.5
                { (int)ObjectIndexes.GoldenEgg, new AnimalItem((int) ObjectIndexes.GoldenEgg, ObtainingDifficulties.End)},
				...
				{ (int)ObjectIndexes.GrassStarter, new CraftableItem((int)ObjectIndexes.GrassStarter, "/Field/297/false/null", CraftableCategories.EasyAndNeedMany) { DifficultyToObtain = ObtainingDifficulties.SmallTimeRequirements } },
				...
				// 1.5
                { (int)ObjectIndexes.RadioactiveBar, new SmeltedItem((int)ObjectIndexes.RadioactiveBar, ObtainingDifficulties.QiItems) },
				...
				// 1.5
				{ (int)ObjectIndexes.BananaSapling, new Item((int)ObjectIndexes.BananaSapling, ObtainingDifficulties.NonCraftingItem) },
                { (int)ObjectIndexes.MangoSapling, new Item((int)ObjectIndexes.MangoSapling, ObtainingDifficulties.NonCraftingItem) },
				...
				// 1.5
				{ (int)ObjectIndexes.TaroTuber, new SeedItem((int)ObjectIndexes.TaroTuber, new List<Seasons> { Seasons.Summer }) { DifficultyToObtain = ObtainingDifficulties.PostgameItems } },
                { (int)ObjectIndexes.PineappleSeeds, new SeedItem((int)ObjectIndexes.PineappleSeeds, new List<Seasons> { Seasons.Summer }) { DifficultyToObtain = ObtainingDifficulties.PostgameItems } },
				...
				// 1.5
				{ (int)ObjectIndexes.TaroRoot, new CropItem((int)ObjectIndexes.TaroRoot, "15/Basic -75") { DifficultyToObtain = ObtainingDifficulties.PostgameItems } },
                { (int)ObjectIndexes.Pineapple, new CropItem((int)ObjectIndexes.Pineapple, "55/Basic -79") { DifficultyToObtain = ObtainingDifficulties.PostgameItems } },

				
				// Items on Ginger Island - not randomizing yet, so marking as impossible
                { (int)ObjectIndexes.Banana, new Item((int)ObjectIndexes.Banana, ObtainingDifficulties.PostgameItems) },
                { (int)ObjectIndexes.OstrichEgg, new AnimalItem((int)ObjectIndexes.OstrichEgg, ObtainingDifficulties.PostgameItems) },
                { (int)ObjectIndexes.GoldenCoconut, new Item((int)ObjectIndexes.GoldenCoconut, ObtainingDifficulties.NonCraftingItem) },
                { (int)ObjectIndexes.Ginger, new Item((int)ObjectIndexes.Ginger, ObtainingDifficulties.NonCraftingItem) },
                { (int)ObjectIndexes.Mango, new Item((int)ObjectIndexes.Mango, ObtainingDifficulties.PostgameItems) },
                { (int)ObjectIndexes.CuriosityLure, new Item((int)ObjectIndexes.CuriosityLure, ObtainingDifficulties.NonCraftingItem) },
                { (int)ObjectIndexes.TigerSlimeEgg, new Item((int)ObjectIndexes.TigerSlimeEgg, ObtainingDifficulties.PostgameItems) },
				// Fish
                { (int)ObjectIndexes.Stingray, new Item((int)ObjectIndexes.Stingray, ObtainingDifficulties.NonCraftingItem) },
                { (int)ObjectIndexes.Lionfish, new Item((int)ObjectIndexes.Lionfish, ObtainingDifficulties.NonCraftingItem) },
                { (int)ObjectIndexes.BlueDiscus, new Item((int)ObjectIndexes.BlueDiscus, ObtainingDifficulties.NonCraftingItem) },
				// Rings
                { (int)ObjectIndexes.LuckyRing, new RingItem((int)ObjectIndexes.LuckyRing) },
                { (int)ObjectIndexes.HotJavaRing, new RingItem((int)ObjectIndexes.HotJavaRing) },
                { (int)ObjectIndexes.ProtectionRing, new RingItem((int)ObjectIndexes.ProtectionRing) },
                { (int)ObjectIndexes.SoulSapperRing, new RingItem((int)ObjectIndexes.SoulSapperRing) },
                { (int)ObjectIndexes.PhoenixRing, new RingItem((int)ObjectIndexes.PhoenixRing) },
                { (int)ObjectIndexes.ImmunityBand, new RingItem((int)ObjectIndexes.ImmunityBand) },
				// Food
                { (int)ObjectIndexes.PinaColada, new CookedItem((int)ObjectIndexes.PinaColada) },
                { (int)ObjectIndexes.GingerAle, new CookedItem((int)ObjectIndexes.GingerAle) },
                { (int)ObjectIndexes.BananaPudding, new CookedItem((int)ObjectIndexes.BananaPudding) },
                { (int)ObjectIndexes.MangoStickyRice, new CookedItem((int)ObjectIndexes.MangoStickyRice) },
                { (int)ObjectIndexes.Poi, new CookedItem((int)ObjectIndexes.Poi) },
                { (int)ObjectIndexes.TropicalCurry, new CookedItem((int)ObjectIndexes.TropicalCurry) },
                { (int)ObjectIndexes.SquidInkRavioli, new CookedItem((int)ObjectIndexes.SquidInkRavioli) },
				// Resources
                { (int)ObjectIndexes.CinderShard, new Item((int)ObjectIndexes.CinderShard, ObtainingDifficulties.PostgameItems) { ItemsRequiredForRecipe = new Range(1, 10), ItemsRequiredForLargeRecipe = new Range(10,20) } },
                { (int)ObjectIndexes.MagmaCap, new Item((int)ObjectIndexes.MagmaCap, ObtainingDifficulties.NonCraftingItem) },
                { (int)ObjectIndexes.DragonTooth, new Item((int)ObjectIndexes.DragonTooth, ObtainingDifficulties.PostgameItems) },
                { (int)ObjectIndexes.GalaxySoul, new Item((int)ObjectIndexes.GalaxySoul, ObtainingDifficulties.QiItems) },
            };
		}
		...
		public static Dictionary<int, int> BigCraftableItems = new Dictionary<int, int> {
			...
			{(int)ObjectIndexes.StoneChest, 232},
            {(int)ObjectIndexes.MiniObelisk, 238},
            {(int)ObjectIndexes.FarmComputer, 239},
            {(int)ObjectIndexes.OstrichIncubator, 254},
            {(int)ObjectIndexes.GeodeCrusher, 182},
            {(int)ObjectIndexes.SolarPanel, 231},
            {(int)ObjectIndexes.BoneMill, 90},
            {(int)ObjectIndexes.HeavyTapper, 264},
            {(int)ObjectIndexes.Hopper, 275}
        };
	}
}

...
namespace Randomizer
{
	...
	public class Item
	{
        ...
        public bool RequiresTapper { get; set; }
        public bool CanStack { get; set; } = true;

		public bool IsResource { get; set; }
        public Range ItemsRequiredForRecipe { get; set; } = new Range(1, 1);
        public Range ItemsRequiredForLargeRecipe { get; set; } = new Range(1, 5);
        ...
        /// <summary>
        /// Gets a large randomly generated amount of this item required for a crafting recipe
        /// Will always return a value of at least multiplier
        /// </summary>
		/// <param name="multiplier">The multiplier for largening.</param>
        /// <returns />
        public int GetLargeAmountRequiredForCrafting(int multiplier = 3)
        {
            int baseAmount = ItemsRequiredForLargeRecipe.GetRandomValue();
            return Math.Max((int)(baseAmount * RequiredItemMultiplier * multiplier), multiplier);
        }
		...
		public int GetPriceForObtainingDifficulty(double multiplier)
		{
			...
			switch (DifficultyToObtain)
			{
                ...
                case ObtainingDifficulties.PostgameItems:
                    basePrice = 25000;
                    break;
                case ObtainingDifficulties.QiItems:
                    basePrice = 30000;
                    break;
